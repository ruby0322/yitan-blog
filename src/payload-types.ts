...
export interface Page {
  ...
  hero: {
    ...
    links?:
      ...
      | null;
    /**
     * highImpact 使用內建胰臟環形 graphic，無需上傳圖片。
     */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "QuoteBlockBlock".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CategoryNavBlock".
 */
export interface CategoryNavBlock {
  sectionNumber?: string | null;
  heading?: string | null;
  items: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "QuoteBlockBlock_select".
 */
export interface QuoteBlockBlockSelect<T extends boolean = true> {
  sectionNumber?: T;
  quote?: T;
  attribution?: T;
  sideText?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CategoryNavBlock_select".
 */
export interface CategoryNavBlockSelect<T extends boolean = true> {
  sectionNumber?: T;
  heading?: T;
  items?:
    | T
